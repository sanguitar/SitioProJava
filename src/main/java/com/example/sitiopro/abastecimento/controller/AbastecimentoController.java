...
public class AbastecimentoController {
    ...
    @InitBinder("abastecimento")
    void restringirCamposAbastecimento(WebDataBinder binder) {
        binder.setAllowedFields("veiculo.id", "data", "litros", "precoPorLitro", "kmNoAto", "local");
    }
