...
public class AdubacaoRequest {
    ...
    @DecimalMin("0.0001") @Digits(integer = 10, fraction = 4) private BigDecimal areaAplicadaHa;
    ...
    public String getProduto() { return produto; } public void setProduto(String v) { produto = v; }
    ...
    public BigDecimal getAreaAplicadaHa() { return areaAplicadaHa; } public void setAreaAplicadaHa(BigDecimal v) { areaAplicadaHa = v; }
